...
export const HIER_DESC =
  "The Hierarchy Editor enables the organization and structuring of attributes into logical groups or derived aggregates. It provides an interactive tree-based interface where attributes can be rearranged, nested, or combined to create new higher-level attributes. Each node in the hierarchy can represent an individual attribute, a composite indicator, or an aggregation of related measures.\nThis component supports the creation of derived attributes using mathematical or logical expressions, allowing the definition of new analytical dimensions tailored to specific research objectives.\nBy simplifying complex datasets into structured hierarchies, the Hierarchy Editor facilitates a clearer overview of cognitive domains and their interrelations, improving both exploration and interpretability.";
...
export const COMP_DESC =
  "The Comparison view allows the analysis of differences between two or more groups for selected attributes. It presents group distributions through swarmplots, histograms, or density plots, and includes integrated hypothesis testing to evaluate whether the observed differences are statistically significant. \nDepending on data characteristics, you can apply the appropriate statistical tests, such as t-tests, ANOVA, Mann–Whitney U... For deeper interpretation, you can review p-values, confidence intervals, and effect sizes that quantify both the statistical and practical significance of group differences.";

export const EVO_DESC =
  "The Evolution component visualizes how attributes change over time across visits or measurement sessions. It can display both individual trajectories and aggregated group trends, helping identify patterns of improvement, decline, or stability. Multiple attributes can be plotted simultaneously to compare their temporal evolution and assess potential correlations. This view supports longitudinal analysis and provides insights into how cognitive performance evolves within and across populations.";

export const CORR_DESC =
  "The Correlation Analysis view examines relationships and dependencies among attributes. It integrates multiple coordinated visualizations—such as correlation matrices, scatterplots, and dimensionality reduction techniques (PCA, t-SNE)—to reveal associations, clusters, and redundancies within the data. Color-coded matrices indicate the strength and direction of pairwise correlations, while interactive scatterplots allow detailed inspection of specific attribute relationships. This view supports the validation of derived measures and helps uncover structural patterns across cognitive domains.";
